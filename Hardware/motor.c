...
{
    float Position_KP_l = 1, Position_KI_l = 0, Position_KD_l = 0;
    float Position_KP_r = 1, Position_KI_r = 0, Position_KD_r = 0;
    ...
    OLED_ShowNum(4, 3, Duty_L, 2);
    OLED_ShowString(4, 7, "R:");
    OLED_ShowNum(4, 9, Duty_R, 2);
    Set_Speed(1, Duty_L);
    Set_Speed(2, Duty_R);
}
